...
export const InteractiveTerminal = () => {
  ...
  const commands = {
    ...
    projects: () => [
      'Security Projects:',
      '• Defence Tools - Cybersecurity toolkit',
      '• Image/Text Encryptor - Secure encryption tools',
      '• Password Analyzer/Generator - Security utilities',
      '• Linux Server Hardening - System security',
      '• AI Fraud Detection - ML-based security',
